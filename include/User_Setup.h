...
// Usar pines SPI por defecto del ESP32
#define TFT_MOSI 35
#define TFT_SCLK 36
#define TFT_CS   39   // O cualquier otro pin GPIO disponible
#define TFT_DC   37  // O cualquier otro pin GPIO disponible
#define TFT_RST  38  // O cualquier otro pin GPIO disponible
...
// Fuentes
#define LOAD_GLCD    // Font 1. Default 8 pixel font included
